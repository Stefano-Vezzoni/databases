...
CREATE TABLE `computer_case` (
  `computer_case_id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`computer_case_id`)
...
INSERT INTO `computer_case` VALUES (1,'Front I/O USB Type-C Port'),(2,'AeroCool Cylon RGB Mid Tower'),(3,'KEDIERS ATX Case Mid-Tower'),(4,'DarkFlash Micro ATX Mini ITX Tower'),(5,'MUSETEX ATX Mid Tower');
